        ...
        */
        ...
        $categories = [
            ...
            [
                'name' => 'Image Tools',
                'slug' => 'image-tools',
                'description' => 'Compress, convert, resize, crop, and rotate images.',
                'icon' => 'image',
                'sort_order' => 3,
            ],
            [
        ...
        */
        ...
        $tools = [
            ...
            [
                ...
                'name' => 'Unlock PDF',
                'slug' => 'unlock-pdf',
                'short_description' => 'Remove password protection from PDFs.',
                'description' => 'Unlock PDF files when you have permission and know the password.',
                'input_types' => ['pdf'],
                'output_types' => ['pdf'],
                'is_premium' => false,
                'requires_login' => false,
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 8,
                'seo_title' => 'Unlock PDF Online | FileGrip',
                'seo_description' => 'Unlock password-protected PDF files online with FileGrip.',
            ],
            [
                'category_slug' => 'security-tools',
                'name' => 'Redact PDF',
                'slug' => 'redact-pdf',
                'short_description' => 'Permanently cover sensitive PDF content.',
                'description' => 'Apply permanent redaction boxes to hide sensitive information in PDF files.',
                'input_types' => ['pdf'],
                'output_types' => ['pdf'],
                'is_premium' => false,
                'requires_login' => false,
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 9,
                'seo_title' => 'Redact PDF Online | FileGrip',
                'seo_description' => 'Redact sensitive information from PDF files online with FileGrip.',
            ],
            [
                'category_slug' => 'security-tools',
                'name' => 'Sign PDF',
                'slug' => 'sign-pdf',
                'short_description' => 'Add a signature to PDF documents.',
                'description' => 'Sign PDF files with typed or uploaded signature content.',
                'input_types' => ['pdf', 'jpg', 'jpeg', 'png', 'webp'],
                'output_types' => ['pdf'],
                'is_premium' => false,
                'requires_login' => false,
                'max_file_count' => 2,
                'max_file_size_mb' => 25,
                'sort_order' => 10,
                'seo_title' => 'Sign PDF Online | FileGrip',
                'seo_description' => 'Add signatures to PDF files online with FileGrip.',
            ],
            [
                'category_slug' => 'edit-tools',
                'name' => 'Add Watermark',
                'slug' => 'add-watermark',
                'short_description' => 'Add text watermark to PDFs.',
                'description' => 'Add custom watermark text to your PDF pages.',
                'input_types' => ['pdf'],
                'output_types' => ['pdf'],
                'is_premium' => false,
                'requires_login' => false,
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 11,
                'seo_title' => 'Add Watermark to PDF Online | FileGrip',
                'seo_description' => 'Add text watermarks to PDF files online with FileGrip.',
            ],
            [
                'category_slug' => 'convert-tools',
                'name' => 'PDF to Image',
                'slug' => 'pdf-to-image',
                'short_description' => 'Convert PDF pages to JPG, PNG, or WEBP images.',
                'description' => 'Convert each page of a PDF into high-quality image files. Choose JPG, PNG, or WEBP output format.',
                'input_types' => ['pdf'],
                'output_types' => ['jpg', 'jpeg', 'png', 'webp', 'zip'],
                'is_premium' => false,
                'requires_login' => false,
                'max_file_count' => 1,
                'max_file_size_mb' => 50,
                'sort_order' => 12,
                'seo_title' => 'PDF to Image Converter Online | FileGrip',
                'seo_description' => 'Convert PDF pages to JPG, PNG, or WEBP images online for free with FileGrip.',
            ],
            [
                'category_slug' => 'convert-tools',
                'name' => 'Image to PDF',
                'slug' => 'image-to-pdf',
                'short_description' => 'Convert JPG, PNG, and WEBP images into PDF.',
                'description' => 'Create one PDF document from JPG, PNG, and WEBP images. Reorder images before converting.',
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 13,
                'seo_title' => 'Image to PDF Converter Online | FileGrip',
                'seo_description' => 'Convert JPG, PNG, and WEBP images to PDF online for free with FileGrip.',
            ],
            [
                'category_slug' => 'convert-tools',
                'name' => 'Word to PDF',
                ...
                'description' => 'Convert DOC, DOCX, ODT, and RTF files into PDF documents.',
                'input_types' => ['doc', 'docx', 'odt', 'rtf'],
                'output_types' => ['pdf'],
                'is_premium' => false,
                'requires_login' => false,
                'max_file_count' => 1,
            ...
            [
                ...
                'description' => 'Convert selectable-text PDF documents into editable Word DOCX files.',
                'input_types' => ['pdf'],
                'output_types' => ['docx'],
                'is_premium' => false,
                'requires_login' => false,
            ...
            [
                ...
                'name' => 'Resize Image',
                'slug' => 'resize-image',
                'short_description' => 'Resize images by width and height.',
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 18,
                'seo_title' => 'Resize Image Online | FileGrip',
                'seo_description' => 'Resize images online with FileGrip.',
            ],
            [
                'category_slug' => 'image-tools',
                'name' => 'Crop Image',
                'slug' => 'crop-image',
                'short_description' => 'Crop images visually.',
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 19,
                'seo_title' => 'Crop Image Online | FileGrip',
                'seo_description' => 'Crop images online with FileGrip.',
            ],
            [
                'category_slug' => 'image-tools',
                'name' => 'Rotate Image',
                'slug' => 'rotate-image',
                'short_description' => 'Rotate images left or right.',
                ...
                'max_file_size_mb' => 25,
                'sort_order' => 20,
                'seo_title' => 'Rotate Image Online | FileGrip',
                'seo_description' => 'Rotate images online with FileGrip.',
            ],
        ];
        ...
        /*
        |--------------------------------------------------------------------------
        | Old Duplicate / Legacy Tools
        |--------------------------------------------------------------------------
        |
        | Keep these records in DB if they already exist, but hide them from web.
        | FileGrip now uses:
        | - pdf-to-image instead of pdf-to-jpg/pdf-to-png/pdf-to-webp
        | - image-to-pdf instead of jpg-to-pdf/png-to-pdf/webp-to-pdf
        |
        */
